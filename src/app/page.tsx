  ...
  return (
    <div className="py-8">
      ...
      <Tabs value={readingType} onValueChange={(v) => setReadingType(v as typeof readingType)}>
        <TabsList className="grid grid-cols-3 sm:grid-cols-6 lg:grid-cols-12 max-w-6xl mx-auto mb-10 bg-purple-950/40 border border-amber-400/20">
...
function ReadingQuestionInput({
  ...
  return (
    <div className="max-w-xl mx-auto mb-6 mt-6">
