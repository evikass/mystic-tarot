...
export function PalmInteractive() {
  ...
  const renderInteractivePalm = () => {
    ...
    const lines: Record<string, string> = {
      ...
      //
      // Линия Жизни: начинается между большим и указательным пальцем (95,155),
      // идёт ВНИЗ дугой, огибая бугор Венеры (основание большого пальца, центр ~68,285)
      // с правой стороны от него. Линия должна быть ПРАВЕЕ бугра Венеры.
      // Заканчивается у запястья (90,355).
      life: "M 95 155 C 80 180 72 230 75 285 C 78 325 85 348 92 355",
      // Линия Головы: начинается рядом с линией Жизни (95,195),
      // идёт горизонтально ВПРАВО через центр ладони
      head: "M 95 195 Q 155 190 230 200",
      // Линия Сердца: выше Головы, прямо под основаниями пальцев (y~155)
      heart: "M 88 155 Q 160 148 242 158",
      // Линия Судьбы: вертикально от запястья вверх к среднему пальцу
      fate: "M 152 358 L 148 140",
      // Линия Солнца: вертикально параллельно, к безымянному
      sun: "M 188 358 L 185 145",
      // ДОПОЛНИТЕЛЬНЫЕ
      mars: "M 100 162 C 88 185 82 230 84 285 C 86 320 92 342 98 352",
      health: "M 178 355 Q 172 285 168 215",
      marriage: "M 250 155 L 253 171 M 245 158 L 248 174 M 255 151 L 258 167",
      children: "M 248 145 L 250 138 M 252 148 L 254 141 M 256 143 L 258 136",
      travel: "M 220 320 Q 230 328 240 322 M 225 335 Q 235 343 245 337",
      intuition: "M 235 310 Q 195 250 168 210",
      "girdle-venus": "M 92 142 Q 160 128 228 142",
      simian: "M 90 175 Q 160 168 235 178",
      "ring-solomon": "M 96 138 Q 108 128 120 138",
      "ring-saturn": "M 130 140 Q 142 130 154 140",
    }
