...
export function PalmInteractive() {
  ...
  const renderInteractivePalm = () => {
    ...
    const lines: Record<string, string> = {
      ...
      // Линия Жизни: начинается между большим и указательным пальцем,
      // идёт ВНИЗ дугой, огибая бугор Венеры (основание большого пальца)
      // слева — но не выходит за контур ладони. Заканчивается у запястья.
      life: "M 95 160 C 72 175 60 220 58 270 C 56 320 66 345 80 354",
      // Линия Головы: начинается рядом с линией Жизни,
      // идёт горизонтально ВПРАВО через центр ладони (ниже Сердца)
      head: "M 95 195 Q 155 188 232 198",
      // Линия Сердца: выше Головы, под основаниями пальцев,
      // но не слишком высоко — между пальцами и центром ладони
      heart: "M 85 168 Q 160 158 245 168",
      ...
      // ДОПОЛНИТЕЛЬНЫЕ
      mars: "M 100 168 C 80 180 70 225 68 270 C 66 315 76 340 90 350",
      health: "M 178 355 Q 172 285 168 215",
      marriage: "M 252 165 L 255 181 M 247 168 L 250 184 M 257 161 L 260 177",
      children: "M 250 155 L 252 148 M 254 158 L 256 151 M 258 153 L 260 146",
      travel: "M 220 320 Q 230 328 240 322 M 225 335 Q 235 343 245 337",
      intuition: "M 235 310 Q 195 250 168 200",
      "girdle-venus": "M 92 155 Q 160 138 230 152",
      simian: "M 90 182 Q 160 173 235 183",
      "ring-solomon": "M 96 150 Q 108 137 120 150",
      "ring-saturn": "M 130 153 Q 142 140 154 153",
    }
