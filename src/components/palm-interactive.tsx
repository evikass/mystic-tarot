...
export function PalmInteractive() {
  ...
  const renderInteractivePalm = () => {
    ...
    const lines: Record<string, string> = {
      ...
      //
      // На левой ладони (большой палец слева, контур большого пальца до x~92):
      // Линия Жизни: начинается между большим и указательным (95,155),
      // идёт ВНИЗ дугой, отстоя от большого пальца на ~30px (x=125-135 в середине),
      // огибает бугор Венеры СПРАВА, возвращается к запястью (100,355).
      life: "M 95 155 C 120 175 135 230 130 290 C 120 325 108 348 100 355",
      // Линия Головы: от (95,220) горизонтально ВПРАВО через центр ладони
      // (опущена на ~20px ниже предыдущей версии)
      head: "M 95 220 Q 155 215 230 225",
      // Линия Сердца: под основаниями пальцев (y=175)
      // (опущена на ~25px ниже предыдущей версии)
      heart: "M 90 175 Q 160 168 242 178",
      ...
      // ДОПОЛНИТЕЛЬНЫЕ
      mars: "M 100 162 C 122 182 138 235 133 290 C 123 325 111 348 103 355",
      health: "M 180 355 Q 175 285 170 230",
      marriage: "M 250 175 L 253 191 M 245 178 L 248 194 M 255 171 L 258 187",
      children: "M 248 165 L 250 158 M 252 168 L 254 161 M 256 163 L 258 156",
      travel: "M 222 320 Q 232 328 242 322 M 227 335 Q 237 343 247 337",
      intuition: "M 237 310 Q 197 250 170 230",
      "girdle-venus": "M 92 162 Q 160 148 228 162",
      simian: "M 90 198 Q 160 192 235 202",
      "ring-solomon": "M 96 158 Q 108 148 120 158",
      "ring-saturn": "M 130 160 Q 142 150 154 160",
    }
    ...
    return (
      <svg viewBox="0 0 300 420" className="w-full h-full max-w-xs mx-auto">
        ...
        {/* === БУГРЫ === */}
        {/* Венера — основание большого пальца (внутри контура, сдвинут вправо) */}
        {renderMount("venus", 95, 295, 20, "#ec4899", "♀")}
